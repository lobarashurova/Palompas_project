...
extension TextExtensions on Text {
  ...
  Text s(double size) => copyWith(
        style: (style ?? GoogleFonts.inter(fontSize: size))
            .copyWith(fontSize: size),
      );

  Text c(Color color) => copyWith(
        style:
            (style ?? GoogleFonts.inter(color: color)).copyWith(color: color),
      );
  ...
  Text h(double height) => copyWith(
        style: (style ?? GoogleFonts.inter(height: height)),
        textAlign: textAlign,
      );
  ...
  Text w(int fontWeight) {
    ...
    return copyWith(
        style: (style ?? GoogleFonts.inter()).copyWith(fontWeight: weight));
  }
